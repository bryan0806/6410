...
#define CONFIG_DM9000_BASE              0x30000300  /* CS4        */
#define DM9000_IO				CONFIG_DM9000_BASE
#define DM9000_DATA			(CONFIG_DM9000_BASE + 0x2)
#define CONFIG_DM9000_USE_16BIT         1
#define CONFIG_ETH_ADDR_IN_ENV          1
...
#define USBD_DOWN_ADDR		0x50008000//0xc0200000
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
	"u-boot="							\
		"tftp 0x50008000 u-boot.bin;"					\
		"nand erase 0x0 0x40000;"					\
		"nand write 0x50008000 0x0 0x40000\0"					\
	"kernel="			\
		"tftp 0x50008000 zImage;"				\
		"nand erase 0x600000 0x300000;"				\
		"nand write 0x50008000 0x600000 0x300000\0"	\
	"ramdisk_uboot="		\
		"tftp 0x50008000 ramdisk-uboot.img;"					\
		"nand erase 0x900000 0x100000;"		\
		"nand write 0x50008000 0x900000 0x100000\0"					\
	"system="		\
		"tftp 0x50008000 system.img;"					\
		"nand erase 0xa00000 0x6400000;"		\
		"nand  write.yaffs 0x50008000 0xa00000 ${filesize}\0"					\
	"userdata="		\
		"tftp 0x50008000 userdata.img;"	\
		"nand erase 0xaa00000 0x5600000;"	\
		"nand write.yaffs 0x50008000 0xaa00000 ${filesize}\0"		\
	"all="                 \
		"run kernel;"       			\
		"run ramdisk_uboot;"				\
		"run system;"				\
...
#define CONFIG_IPADDR		192.168.2.144
#define CONFIG_SERVERIP		192.168.2.30
...
#define CFG_PROMPT		"MEME28 # "	/* Monitor Command Prompt	*/
...
#define Startup_HCLKx2div	2
#elif defined(CONFIG_CLK_666_133_66)
#define Startup_APLLdiv		0
...
#define CONFIG_BOOTCOMMAND	"nand read 50008000 600000 300000;nand read 50800000 900000 100000;bootm 50008000 50800000"    //modify by zhb
